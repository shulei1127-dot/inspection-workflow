...
def _build_result(
    ...
    return AuditResult(
        ...
        crm_project_id=input.crm_project_id,
        sales_name=input.sales_name,
        sales_pts_id=input.sales_pts_id,
        sales_pts_username=input.sales_pts_username,
        sales_lookup_status=input.sales_lookup_status,
        rules=rules,
